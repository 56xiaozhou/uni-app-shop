  ...
  <view class="sk-container">
    <scroll-view :scroll-y="true" class="viewport viewport" :enable-back-to-top="true">
      <view class="goods goods">
        ...
        <view class="meta meta">
          <view class="price price">
            ...
            <text class="number sk-transparent sk-text-14-2857-378 sk-text">129.00</text>
          </view>
          <view class="name ellipsis sk-transparent sk-text-14-2857-414 sk-text"
            >爆款明星好物，抽屉式透明储物柜</view
          >
          <view class="desc sk-transparent sk-text-0-0000-871 sk-text"
            >抽屉随意拉，东西随意拿，7款尺寸，随意叠加搭配app</view
          >
        </view>
        <view class="action action">
          <view class="item arrow sk-pseudo sk-pseudo-circle">
            <text class="label sk-transparent sk-text-14-2857-486 sk-text">选择</text>
            <text class="text ellipsis sk-transparent sk-text-14-2857-171 sk-text">
              请选择商品规格
            </text>
          </view>
          <view class="item arrow sk-pseudo sk-pseudo-circle">
            <text class="label sk-transparent sk-text-14-2857-493 sk-text">送至</text>
            <text class="text ellipsis sk-transparent sk-text-14-2857-595 sk-text">
              请选择收获地址
            </text>
          </view>
          <view class="item arrow sk-pseudo sk-pseudo-circle">
            <text class="label sk-transparent sk-text-14-2857-412 sk-text">服务</text>
            <text class="text ellipsis sk-transparent sk-text-14-2857-752 sk-text">
              无忧退 快速退款 免费包邮
            </text>
          </view>
        </view>
      ...
      <view class="detail detail panel panel">
        <view class="title title">
          <text class="sk-transparent sk-text-0-0000-136 sk-text">详情</text>
        </view>
        <view class="content content">
          <view class="properties properties">
            <view class="item item">
              <text class="label sk-transparent sk-text-25-0000-689 sk-text">材质</text>
              <text class="value sk-transparent sk-text-25-0000-68 sk-text">塑料</text>
            </view>
          </view>
        </view>
      </view>
    ...
    <view class="toolbar toolbar" style="padding-bottom: 34px">
      ...
      <view class="buttons buttons">
        <view
          class="addcart sk-transparent sk-text-31-9444-290 sk-text"
          style="background-position-x: 50%"
        >
          加入购物车
        </view>
        <view
          class="buynow sk-transparent sk-text-31-9444-193 sk-text"
          style="background-position-x: 50%"
        >
          立即购买
        </view>
