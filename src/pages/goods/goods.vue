...
const onChange: UniHelper.Swiper.SwiperOnChange = (ev) => {
  currIndex.value = ev.detail!.current
}
  ...
  <scroll-view v-if="isFinish">
    ...
    <view class="toolbar" :style="{ paddingBottom: safeAreaInsets?.bottom + 'px' }">
      <view class="icons">
        ...
        <navigator class="icons-button" url="/pages/cart/cart-two" open-type="navigate">
